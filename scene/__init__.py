...
from scene.robot_dataset import RobotDataset, RobotPoseDataset
...
class RobotPoseScene:
    ...
    def __init__(self, args : ModelParams, 
        ...
        if load_iteration:
            ...
            print("[Scene] Loading trained intialization model at iteration {}".format(self.loaded_iter))
    ...
    def load_datasets(self):
        self.canonical_cameras = RobotPoseDataset(dataset_path=self.opt_params.dataset_path, stage='canonical')
        self.pose_conditioned_cameras = RobotPoseDataset(dataset_path=self.opt_params.dataset_path, stage='pose_conditioned')
